...
class TournamentView(View):
    ...
    def select_tournament(self, tournaments):
        """
        Affiche une liste de tournois existants et demande à
        l'utilisateur d'en sélectionner un.
        ...
        for i, tournament in enumerate(tournaments_reversed):
            ...
            print(
                f"{i + 1} - {tournament['name']} à {tournament['location']} "
            ...
            try:
                ...
                if tournament_index < 0 or tournament_index >= len(tournaments):
                    print("Numéro de tournoi invalide. "
                          "Veuillez entrer un numéro de tournoi valide.")
                else:
